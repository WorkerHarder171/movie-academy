...
export const HeroDesktop = () => {
  return (
    <section>
      <div className="relative flex py-16 items-center justify-center bg-[#d6ddf4] bg-cover bg-center">
        <Image
          src={bgHero}
          quality={100}
          fill
        ...
        <div className="container mx-auto z-20 flex flex-col items-center justify-center gap-6 px-6 pb-5 pt-10">
          ...
          <p className="text-center text-bodyTextDark tracking-wider leading-relaxed">
            {" "}
